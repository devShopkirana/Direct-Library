...
public class PaymentActivity extends AppCompatActivity implements View.OnClickListener, DeliveryOptionInterface {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) {
            ...
            mBinding.btnAdd.setText(DirectSDK.getInstance().dbHelper.getString(R.string.change));
    ...
    private void initView() {
        mBinding.tvOrderValueH.setText(DirectSDK.getInstance().dbHelper.getString(R.string.total_order_value));
        mBinding.tvAmountH.setText(DirectSDK.getInstance().dbHelper.getString(R.string.total_amount));
        mBinding.tvItemPrice.setText(DirectSDK.getInstance().dbHelper.getString(R.string.price_details));
        mBinding.tvAddress.setText(DirectSDK.getInstance().dbHelper.getString(R.string.address));
        mBinding.tvCodTitle.setText(DirectSDK.getInstance().dbHelper.getString(R.string.cash_on_delivery));
        mBinding.tvDOption.setText(DirectSDK.getInstance().dbHelper.getString(R.string.delivery_option));
        mBinding.btnPlaceOrder.setText(DirectSDK.getInstance().dbHelper.getString(R.string.place_order));
        mBinding.tvSelectPromoTitle.setText(DirectSDK.getInstance().dbHelper.getString(R.string.select_a_promo_code));
        mBinding.btnOffer.setText(DirectSDK.getInstance().dbHelper.getString(R.string.view_offer));
        mBinding.tvPaymentTitle.setText(DirectSDK.getInstance().dbHelper.getString(R.string.title_activity_payment));
        mBinding.btnAdd.setText(DirectSDK.getInstance().dbHelper.getString(R.string.change));
        mBinding.tvDeleveryCharge.setText(DirectSDK.getInstance().dbHelper.getString(R.string.delivery_charge));
    ...
    public void orderPlaceAlertDialog() {
        ...
        builder.setNegativeButton(DirectSDK.getInstance().dbHelper.getString(R.string.no), (dialog, which) -> {
    ...
    private void userLocationAPI() {
        ...
        paymentViewMode.getUserLocationVM().observe(this, locationModel -> {
            ...
            if (locationModel.isSuccess() && locationModel.getResultItem().size() > 0) {
                ...
                mBinding.btnAdd.setText(DirectSDK.getInstance().dbHelper.getString(R.string.add_new_address));
            }
        });
    }
